...
// 构建游戏风格提示词
function buildPrompt(type: 'character' | 'background', theme: string, customPrompt?: string): string {
  const baseTemplate = type === 'character'
    ? GAME_TEMPLATES.positive.character
    : GAME_TEMPLATES.positive.background
